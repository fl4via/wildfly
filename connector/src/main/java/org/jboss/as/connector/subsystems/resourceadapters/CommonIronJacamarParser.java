...
import static org.jboss.as.connector.subsystems.resourceadapters.Constants.ELYTRON_SECURITY_DOMAIN;
import static org.jboss.as.connector.subsystems.resourceadapters.Constants.ELYTRON_SECURITY_DOMAIN_AND_APPLICATION;
...
import static org.jboss.as.connector.subsystems.resourceadapters.Constants.RECOVERY_ELYTRON_SECURITY_DOMAIN;
                ...
                case START_ELEMENT: {
                    switch (Security.Tag.forName(reader.getLocalName())) {
                        ...
                        case ELYTRON_SECURITY_DOMAIN: {
                            ...
                            String value = rawElementText(reader);
                            ELYTRON_SECURITY_DOMAIN.parseAndSetParameter(value, node, reader);
                            securtyDomainMatched = true;
                            break;
                        }
                        case ELYTRON_SECURITY_DOMAIN_AND_APPLICATION: {
                            String value = rawElementText(reader);
                            ELYTRON_SECURITY_DOMAIN_AND_APPLICATION.parseAndSetParameter(value, node, reader);
                            break;
                        }
                        case APPLICATION: {
                            String value = rawElementText(reader);
            ...
            switch (reader.nextTag()) {
                ...
                case START_ELEMENT: {
                    switch (Credential.Tag.forName(reader.getLocalName())) {
                        ...
                        case ELYTRON_SECURITY_DOMAIN: {
                            String value = rawElementText(reader);
                            RECOVERY_ELYTRON_SECURITY_DOMAIN.parseAndSetParameter(value, node, reader);
                            break;
                        }
                        default:
                            throw ParseUtils.unexpectedElement(reader);
