...
public class ClusteredSingletonServiceCreator extends AbstractService<Void> {
    ...
    @Override public void start(StartContext context) throws StartException {
        ...
        final ClusteredSingletonService service = new ClusteredSingletonService();
        singletonPolicyValue.createSingletonServiceBuilder(EJB3SubsystemRootResourceDefinition.CLUSTERED_SINGLETON_CAPABILITY.getCapabilityServiceName(), service)
                .build(target)
