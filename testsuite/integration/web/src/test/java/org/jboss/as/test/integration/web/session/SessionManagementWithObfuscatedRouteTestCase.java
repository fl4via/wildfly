...
public class SessionManagementWithObfuscatedRouteTestCase {
    ...
    public static Archive<?> dependent() {
        return ShrinkWrap.create(WebArchive.class, "management.war")
                .addClasses(SessionTestServletWithObfuscatedRouteRetrieval.class)
                .addAsManifestResource(new StringAsset("Dependencies: org.jboss.as.server, org.wildfly.extension.undertow\n"), "MANIFEST.MF");
    }
...
class UndertowObfuscatedSessionRouteServerSetup implements ServerSetupTask {
