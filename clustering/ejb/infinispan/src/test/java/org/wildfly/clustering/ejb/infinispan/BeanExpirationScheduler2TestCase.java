...
public class BeanExpirationScheduler2TestCase {
    @Test
    public void testImmortal() throws InterruptedException {
        ...
        try (Scheduler2<String> scheduler = new BeanExpirationScheduler2<>(batcher, remover, config)) {
